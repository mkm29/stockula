...
class TestStrategiesFinalCoverage:
    ...
    def setup_method(self):
        ...
        self.sample_high = [price + abs(np.random.randn() * 2) for price in self.sample_close]
        self.sample_low = [price - abs(np.random.randn() * 2) for price in self.sample_close]
    ...
    def test_insufficient_data_warnings_comprehensive(self):
        ...
        for strategy_class, insufficient_length in warning_test_cases:
            ...
            strategy.I = Mock(side_effect=lambda func, *args, **kwargs: [1.0] * insufficient_length)
    ...
    def test_class_methods_comprehensive(self):
        ...
        for strategy_class in [TripleEMACrossStrategy, TRIMACrossStrategy, VIDYAStrategy, KAMAStrategy, FRAMAStrategy]:
    ...
    def test_calculation_functions_direct_execution(self):
        ...
        strategy.I = Mock(side_effect=lambda func, *args, **kwargs: func(*args, **kwargs))
        ...
        strategy = self.create_mock_strategy(FRAMAStrategy)
        strategy.data.Close = [100 + np.sin(i/10) * 5 for i in range(60)]  # Oscillating prices
        strategy.I = Mock(side_effect=lambda func, *args, **kwargs: func(*args, **kwargs))
